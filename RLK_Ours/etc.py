...
weights_path    = "/nasdata4/mjh/Diffusion/2_Segmentation/1_RLK_final/4_RLK_Ours/weights_experiments/weight_density_lrschedule"

for fold in range(2, folds_num, 1):
