...
lacune_path = '/nasdata4/mjh/VALDO/tar/LACUNE/segmentation/cohort_rlk/with_lacune'

flair_path = os.path.join(lacune_path, "flair_mni")
t1_path = os.path.join(lacune_path, "t1_mni")
t2_path = os.path.join(lacune_path, "t2_mni")
label_path = os.path.join(lacune_path, "Rater_mni")
...
weights_path    = "/nasdata4/mjh/Diffusion/2_Segmentation/1_RLK_final/4_RLK_Ours/weights/weight_density_multi_lambda_5fold_preset_nnunet/Fold_5"
...
weights_load_path = os.path.join(weights_path, "Best_RLK-Unet_HF_Pxl_Rec_epoch600.pth")
