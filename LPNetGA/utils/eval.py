...
class Evaluator:
    ...
    def target_metrics(self):
        ...
        for idx in range(len(self.pred_list)):
            ...
            pred = self.pred_list[idx] # (224, 224)
    ...
    def dice_metrics(self):
        ...
        for idx in range(len(self.pred_list)):
            ...
            dice_score = dice(pred_tensor, gt_tensor).mean().item()
            dice_score_lst.append(dice_score)
        
        mean_test_dice_score = np.nanmean(dice_score_lst)
        
        return mean_test_dice_score